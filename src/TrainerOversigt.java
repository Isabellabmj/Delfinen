...
public class TrainerOversigt
{
    protected ArrayList<Trainer> traenerListe = new ArrayList<>();
    protected String diciplin;


    // Opret oversigt over trænere

    public TrainerOversigt()
    {
    ...
    public void createTraenerOversigt() {
        ...
        for (int i = 0; i < 10; i++)
        {
            CprNr cpr = new CprNr(true); // Generer CprNr
            ...
            traenerListe.add(new Trainer(navn, cpr, telNr, mail, diciplin));

        }
    }

    public ArrayList<Trainer> getTraenerListe()
    {
        return traenerListe;
    }

    public void addTraenerToTraenerOversigt(Trainer t)
    {
        traenerListe.add(t);
    }
